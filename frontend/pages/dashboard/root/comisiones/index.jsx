  ...
  return (
    <LayoutRoot>
      <div className="flex items-center justify-between mb-4">
        ...
        {role === 'root' && (
          <Link href="/dashboard/root/comisiones/configuracion" className="px-4 py-2 bg-primary text-white rounded hover:opacity-75">
              ...
              {data.map((item) => (
                <tr key={item.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <Link
                      href={`/dashboard/root/comisiones/${item.id}?month=${filterMonth}&year=${filterYear}`}
